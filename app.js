...
function showAdminDirectivos() {
    ...
    const directivos = [
        ...
        { nombre: 'José Luis Díaz Polentino', cargo: 'Secretario', foto: 'img/Directivos/Jose Luis díaz Polentino-Secretario FUNJOVIR.png', descripcion: 'Diseñador Industrial con experiencia en innovación social, formador de Juntas de Acción Comunal y Juntas Administradoras Locales. Gestor cultural.', pdf: 'hoja_vida_jose.pdf' },
...
function showAdminGestiones() {
    const adminContent = document.getElementById('adminContent');
    const gestiones = [
        { periodo: 'Enero - Marzo 2025', titulo: 'Aprobación Presupuesto Anual', resumen: 'Aprobación del presupuesto anual por $10 millones COP para la ejecución de programas sociales en 2025. Se destinaron recursos para educación, deporte e infraestructura.', pdf: 'informe_trim1.pdf' },
        { periodo: 'Abril - Junio 2025', titulo: 'Alianzas Estratégicas', resumen: 'Firma de alianza con 5 empresas locales para pasantías juveniles. Se beneficiaron 15 jóvenes con prácticas laborales en empresas del sector productivo.', pdf: 'informe_trim2.pdf' },
        { periodo: 'Julio - Septiembre 2025', titulo: 'Inauguración Centro Comunitario', resumen: 'Inauguración del nuevo centro comunitario en Villa Rosa con capacidad para 100 personas diarias. Incluye aula tecnológica, comedor y zona deportiva.', pdf: 'informe_trim3.pdf' },
...
function loadESALDocuments() {
    ...
    const documentos = [
        { nombre: 'Formulario de inscripción al RUT', descripcion: 'Documento de Registro Único Tributario actualizado ante la DIAN. Requisito fundamental para la identificación tributaria de la fundación.', pdf: 'Documentos/esal/RUT FUNJOVIR 2026.pdf' },
        { nombre: 'Estatutos de la fundación', descripcion: 'Documento legal que contiene las normas de funcionamiento, estructura organizacional y objetivos de la fundación. Aprobados por asamblea.', pdf: 'Documentos/esal/ESTATUTOS FUNJOVIR.pdf' },
        { nombre: 'Cámara de Comercio actualizada', descripcion: 'Certificado de existencia y representación legal vigente con matrícula mercantil activa. Documento que acredita la personería jurídica.', pdf: 'Documentos/esal/CERTIFICADO DE EXISTENCIA Y REPRESENTACIÓN LEGAL.pdf' },
        { nombre: 'Informes de gestión anual', descripcion: 'Informe detallado de las actividades, logros y metas alcanzadas durante el año fiscal. Incluye indicadores de impacto social.', pdf: 'Documentos/esal/INFORME ANUAL VIGENCIA 2026.pdf' },
        { nombre: 'Estados financieros dictaminados', descripcion: 'Balance general y estados de resultados auditados por revisor fiscal. Cumple con normas internacionales de contabilidad.', pdf: 'Documentos/esal/ESTADOS FINANCIEROS 2026.pdf' },
        { nombre: 'Certificación de representante legal', descripcion: 'Documento que acredita al representante legal de la fundación con sus facultades y poderes. Firmado por el presidente de la junta.', pdf: 'Documentos/esal/CERTIFICACIÓN DE REQUISITOS FUNDACIÓN 2026.pdf' }
    ];
    if (!container) return;
    container.innerHTML = '';
...
function loadUpcomingActivities() {
    const activities = [
        { date: '2026-09-13', name: '🎁 Entrega de ayudas comunitarias', location: 'Sede Principal' },
        { date: '2026-10-31', name: '📚 fiesta de los niños', location: 'Centro Comunitario' },
        { date: '2026-11-11', name: '👩 Evento deportivo', location: 'Parque Villa Rosa' },
        { date: '2026-12-01', name: '⚽ Torneo de fútbol juvenil', location: 'Cancha Comunitaria' },
        { date: '2026-12-24', name: '💻 Entrega de regalos', location: 'HIC' }
    ];
